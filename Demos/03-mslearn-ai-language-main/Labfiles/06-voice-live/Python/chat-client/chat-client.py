...
class VoiceAssistant:
    """
    Assistente de voz que coordena o fluxo da conversa.
    """
...
class AudioProcessor:
    """
     Manipule a entrada de audio corretamente, enviando para o serviço e reproduzindo as respostas do agente.
    """
    ...
    def queue_audio(self, audio_data):
        """adicione o audio a fila."""
        self.playback_queue.put(audio_data)
    
    def clear_playback_queue(self):
        """limpe qualquer audio pendente."""
